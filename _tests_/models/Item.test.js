...
describe('Item model test', () => {
    ...
    describe('deletes Item', () => {
        ...
        test('returns null when deleting a non-existent Item but with a valid id', async () => {
            expect.assertions(1)
            const validIdButNonExistentItem = '5ccb1fac5572f3b82688dc40'

            const response = await Item.findByIdAndDelete(validIdButNonExistentItem)
